            ...
            switch (_d.label) {
                case 0:
                    ...
                    getPlayerTopStat = function ($, index) {
                        var playerHref = $($('.most-x-box').get(index))
                            .find('.name > a')
                            .attr('href');
                        if (!playerHref) {
                            return undefined;
                ...
                case 1:
                    ...
                    teamStats = teamStatProperties.reduce(function (res, prop, i) {
                        var _a;
                        return (__assign(__assign({}, res), (_a = {}, _a[prop] = getMatchInfoRowValues(m$, i + 1), _a)));
                    }, {});
                    mostXProperties = [
                        'mostKills',
                        'mostDamage',
                    ...
                    playerOverviewStats = mappers_1.toArray(m$('.stats-table tbody tr')).map(function (rowEl) {
                        ...
                        return __assign({ id: id, name: rowEl.find('.st-player a').text(), kills: Number(rowEl
                                ...
                                .find('.st-kdratio')
                                .text()
                                .replace('%', '')) || undefined, killDeathsDifference: Number(rowEl.find('.st-kddiff').text()), ADR: Number(rowEl.find('.st-adr').text()) || undefined, firstKillsDifference: Number(rowEl.find('.st-fkdiff').text()), rating: Number(rowEl.find('.st-rating').text()) }, performanceStats);
                    });
                    playerStats = {
                    ...
                    performanceOverview = mappers_1.toArray(p$('.overview-table tr'))
                        ...
                        return {
                            team1: __assign(__assign({}, res.team1), (_a = {}, _a[property] = team1Stat, _a)),
                            team2: __assign(__assign({}, res.team2), (_b = {}, _b[property] = team2Stat, _b))
                        };
                    }, {});
                    return [2, {
